        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex space-x-6">
              <a href="https://www.facebook.com/BildungsCluster" className="text-gray-300 hover:text-white transition-colors" target="_blank"><Facebook className="w-5 h-5" /></a>
              <a href="https://www.twitter.com/BildungsCluster" className="text-gray-300 hover:text-white transition-colors" target="_blank"><Twitter className="w-5 h-5" /></a>
              <a href="https://www.instagram.com/bildungscluster/" className="text-gray-300 hover:text-white transition-colors" target="_blank"><Instagram className="w-5 h-5" /></a>
            </div>
          </div>
        </div>
      </div>
